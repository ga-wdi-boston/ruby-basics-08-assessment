...
Diagnostic.predicate = puts "odd: #{odd_num}"
...
Diagnostic.remove_from_array = arr.delete_at(-1, -2)
...
Diagnostic.person_hash = person_hash = {age: "", first_name: ""}

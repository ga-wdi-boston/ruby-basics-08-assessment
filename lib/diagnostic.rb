...
Diagnostic.variable = 'star_wars_epidose_viii' (Class variable?  local variable?@@  Global?$)
...
Diagnostic.remove_from_array = 'arr.delete something, running out of time!'

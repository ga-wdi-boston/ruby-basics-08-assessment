...
Diagnostic.person_hash = '{ first_name: "Jay" , favorite_number: 7 }'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person_hash.default = "#{person_hash[:first_name]} does not have that property. Try again"'

...
Diagnostic.flow_control = 'if since its the last expression executed ???'
...
Diagnostic.person_hash = 'person[:favorite_number] = 14'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = ' person = Hash.new { |hash, key| hash[key] = "#{first_name} is a super-dude." }'

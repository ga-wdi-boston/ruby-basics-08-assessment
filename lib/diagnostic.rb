...
Diagnostic.remove_from_array = 'arr[-2..-1] = [] '
...
Diagnostic.person_hash = 'person = {age:28,first_name:"Patrick"}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = "#{person[:fist_name]} does not have
 a value defined for that symbol!!!"'

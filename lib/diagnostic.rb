...
Diagnostic.script = "require 'example.rb'"
...
Diagnostic.variable = 'star_wars_ep5'
...
Diagnostic.flow_control = 'he Dark Knight'
...
Diagnostic.person_hash = 'person = {first_name:"Wei",age:100}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = proc do |hash , key|
'person.default("#{person[:first_name]} does not have the #{key} you typed, please add a value to it.")'
end

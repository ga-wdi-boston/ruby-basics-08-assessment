...
Diagnostic.predicate = odd?(3) # => true
...
Diagnostic.integer = 'Fixnum' # or Bignum, but this is not commonly used
...
Diagnostic.person_hash = 'person = {age: 30, first_name: "Alex"}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = {|person, key| "#{person} does not have a #{key}"}'

...
Diagnostic.decimal = 'Decimals are a flat object, which is part of the numberic class of object'

# What is the type of object in Ruby for integer numbers? Write your answer in
# a Ruby string.

Diagnostic.integer = 'Integers are an integer object, which is part of the numeric class of object'

# Write an example of a decimal and an integer in Ruby. Replace the Ruby strings
# in the following array with your examples.

Diagnostic.numbers = ['5.7', '8']
...
Diagnostic.array_add_to = 'Not sure what this question is asking. Without the last to elements, arr=[12,34]'
...
Diagnostic.person_hash = '{@favorite_number = favorite_number,  @first_name = first_name}'

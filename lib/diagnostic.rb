...
Diagnostic.predicate = is_odd?(12)
# Numbers in Ruby
#
...
# I originally had '[12, 34, nil, nil, 99],' as pop mutates the original array
# but this failed the rspec test so I changed it...
...
Diagnostic.person_hash = 'person = {first_name: "Tuck", age: 28}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = "#{person[:first_name]} is the best!"'

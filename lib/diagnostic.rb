...
Diagnostic.predicate =  is_odd (number) = if number.isodd == true
                                            puts number
...
Diagnostic.array_add_to = 'arr = [12, 34, nill, 99]'

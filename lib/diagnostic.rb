...
Diagnostic.variable = '_starwars = star wars episode viii'
...
Diagnostic.flow_control = 'The Dark Knight will return because batman is true to
the first variable'
...
Diagnostic.remove_from_array = 'arr.delete(56); arr.delete(67)'

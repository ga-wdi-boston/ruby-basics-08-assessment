...
Diagnostic.remove_from_array = arr.slice!(2, arr.length)
...
Diagnostic.person_hash = [:favorite_number => 32, :first_name => "tony"]

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = person.default = "Hi my name is #{person[:first_name]}
and my favorite number is #{person[:favorite_number]}"

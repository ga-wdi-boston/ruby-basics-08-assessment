...
Diagnostic.repl = 'starwarsepisodeviii.method'
...
Diagnostic.interpolation = 'See below'

character = 'Jar Jar Binks'
puts '#{name} is really a Sith Lord.'
...
Diagnostic.returns = true, it is "return"
...
Diagnostic.remove_from_array = 'a.pop' twice :p

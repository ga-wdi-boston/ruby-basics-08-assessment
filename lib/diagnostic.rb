...
Diagnostic.variable = name_of_movie = "star wars episode viii"
...
Diagnostic.person_hash = 'person = {favorite_number: 2, first_name:'Bob'}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person_hash.default = "#{first_name} is not here right now"'

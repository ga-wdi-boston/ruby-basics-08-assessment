...
'Decimal can also be used for greater precision.'
...
Diagnostic.person_hash = 'person = { favorite_number: 7, first_name: "spencer" }'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = Hash.new { |hash, key| hash[key] = "Key #{first_name} is now part of person hash" }

...
Diagnostic.interpolation = '"" + character.to_s + " is really a Sith Lord."'
...
#Didn't have time to complete this one. I just needed a few more minutes!

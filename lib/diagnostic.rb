...
# convention is to use underscores and lowercase
...
# I think the distinction from js is that it's one word instead of two?
...
Diagnostic.person_hash = '{person: [favorite_number: 42, first_name: ross]}'

# I don't think this is right, needed more time

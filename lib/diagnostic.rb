...
Diagnostic.interpolation = "#{character} is a plague upon the Galaxy."
...
Diagnostic.predicate = odd_num(num)
...
Diagnostic.person_hash = 'Hash.new(0).merge{ age: 42, first_name: 'Zaphoid'}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default{ |h, k| h[k]: "Hello #{first_name}!"}'

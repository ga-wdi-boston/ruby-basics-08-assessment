...
Diagnostic.script = 'http('lib/example.rb')'
...
#They're called floats. See below for an example.
Diagnostic.decimal = '2.1**2'


# What is the type of object in Ruby for integer numbers? Write your answer in
# a Ruby string.

Diagnostic.integer = '24.0.to_i'
#Is this what you mean? The wording of this question is a bit confusing.

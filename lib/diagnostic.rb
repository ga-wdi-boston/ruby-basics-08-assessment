...
Diagnostic.interpolation = '#{character[0]} is really a Sith Lord.'
...
Diagnostic.predicate = def odd? do | num | num.odd? end end
...
Diagnostic.array_add_to = 'arr = [12, 34, 56, 67, 99]'

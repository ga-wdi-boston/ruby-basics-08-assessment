...
Diagnostic.interpolation = "#{character} is really a Sith Lord." #need double quotes!
...
Diagnostic.defined_method = method_name(3, 4)
...
Diagnostic.predicate = odd?(5) #returns true

...
Diagnostic.variable = "var = 'star wars episode viii'"
...
Diagnostic.person_hash = {:age : 'number-age', :first_name : 'first-name'}

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'Array.new(0)|hash key| [:first_name] is a developer)'

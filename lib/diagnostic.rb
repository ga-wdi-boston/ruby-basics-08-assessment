...
Diagnostic.decimal = 'float' # or number.to_f ?

# What is the type of object in Ruby for integer numbers? Write your answer in
# a Ruby string.

Diagnostic.integer = 'integer' # or number.to_i
...
Diagnostic.returns = false # returns are implicit

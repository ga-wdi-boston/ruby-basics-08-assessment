...
#Also there is totally a method already built onto integers to check this...

Diagnostic.predicate = odd?(3)
...
Diagnostic.person_hash = 'person = {age: 22, first_name: "James"}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = "#{person[:first_name]} is my brother."'

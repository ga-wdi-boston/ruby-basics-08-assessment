...
Diagnostic.decimal = "decimal numbers in ruby are called floats"
...
Diagnostic.array_add_to = 'I keep staring at this and not understanding what it is asking'
...
Diagnostic.person_hash = 'person = { :age => 3, :first_name => "Dan"}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = "#{person[first_name]} loves alcohol, board games, and dancing."'

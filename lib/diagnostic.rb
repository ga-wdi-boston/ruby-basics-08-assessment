...
Diagnostic.predicate = num_odd?(5)
...
Diagnostic.decimal = 'floating point number (float)'

# What is the type of object in Ruby for integer numbers? Write your answer in
# a Ruby string.

Diagnostic.integer = 'integer (int)'
...
Diagnostic.array_add_to = 'The previous array with two nils and then 99 at the end'

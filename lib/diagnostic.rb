...
Diagnostic.script = 'from the directory I would run: ruby lib/example.rb'
...
Diagnostic.remove_from_array = 'arr.slice!(2..3)'
...
Diagnostic.person_hash = 'person = { :favorite_number => 10, :first_name => "Joe"}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'my name is #{person.values[1]}I count to #{person.values[0]}'

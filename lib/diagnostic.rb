...
Diagnostic.variable = print "star wars episode viii"
...
Diagnostic.interpolation = print '#{character} is really a Sith Lord.'
...
Diagnostic.numbers = ['50.067879', '8']
...
Diagnostic.remove_from_array = arr.delete_if {|item| item > 34}

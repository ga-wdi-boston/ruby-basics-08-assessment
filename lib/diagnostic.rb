...
Diagnostic.remove_from_array = 'arr.shift(2)'
...
Diagnostic.person_hash = 'class Person attr_accessor :favorite_number
attr_accessor :first_name def initialize (favorite_number, first_name)
@favorite_number = favorite_number @first_name = first_name end end'
# "van = Person.new(28, 'Van')"

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = '#{first_name} is a student at GA'

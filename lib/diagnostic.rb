...
Diagnostic.decimal = 'Decimal(a)'
Diagnostic.decimal = '(a).to_f'


# What is the type of object in Ruby for integer numbers? Write your answer in
# a Ruby string.

Diagnostic.integer = '(a).to_i'
...
Diagnostic.person_hash = 'people{:favorite_number :first_name}'

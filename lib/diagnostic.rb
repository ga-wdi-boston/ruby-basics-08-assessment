...
Diagnostic.variable = 'john_boyega = "star wars episode viii"'
...
Diagnostic.defined_method = method_name(1, 2)
...
# replace nil.
Diagnostic.returns = 'no it returns the last line'

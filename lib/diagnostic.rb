...
# need double quotes to interpolate
...
Diagnostic.person_hash = 'person = { age: 23, first_name: Samuel }'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = "#{person.first_name} can\'t think of a joke here"'

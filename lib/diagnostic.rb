...
Diagnostic.variable = 'read_in_english = "star wars episode viii"'
...
Diagnostic.person_hash = 'person = Hash.new { | hash, key | hash[key] = {favorite_number[7], first_name["joao"]} }'

...
Diagnostic.variable = 'new_variable = "star wars episode viii"'
...
Diagnostic.predicate = # call your meth
...
Diagnostic.flow_control = String.new("nothing will return - not conditionals
and no p or puts")

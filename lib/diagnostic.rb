...
Diagnostic.interpolation = "#{character} is really a Sith Lord." # switched to double quotes
...
Diagnostic.defined_method = twice_product(num1, num2)
...
Diagnostic.array_iteration = :each

...
Diagnostic.script = 'ruby diagnostic.rb'
...
Diagnostic.repl = 'irb Diagnostic.repl'
...
Diagnostic.variable = def "star was episode viii"
...
Diagnostic.predicate = a.values_at(* a.each_index.select {|i| i.odd?})
...
Diagnostic.flow_control = 'Bruce WayneJust your average billionaire'
...
Diagnostic.remove_from_array = 'arr.pop'

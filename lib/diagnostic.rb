...
Diagnostic.variable = 'variable = star_wars_episode_vii'
...
odd_sum.range.reduce { |a, e| e.odd? ? a + e : a }

Diagnostic.predicate = puts '#{odd_sum}'

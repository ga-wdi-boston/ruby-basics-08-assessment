...
def star_wars_episode_viii
  # p 'star_wars_episode_viii'
end
...
Diagnostic.person_hash = {favorite_number: 2, first_name: 'Matt'}

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = "#{@person_hash.first_name} is so cool. the best. yuge."

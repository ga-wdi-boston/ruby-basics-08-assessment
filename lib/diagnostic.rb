...
# The rake test failed for below, but this way still works.
...
# The rake test for this is incorrect.  It uses the original array and not the
# result from the last question.
...
Diagnostic.hash_default = 'person.default = "#{person[:first_name]} likes skiiing"'

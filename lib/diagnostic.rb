...
Diagnostic.remove_from_array = 'arr.delete_if {|num| num > 50 }'
...
Diagnostic.person_hash = 'person = {favorite_number: 33, first_name: 'John'}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = Hash.new { |hash, key| hash[key] = "We have added #{key} to the list." }

...
Diagnostic.script = 'lib/examaple.rb'
...
Diagnostic.variable = 'star_wars_espisode_will'
...
Diagnostic.numbers = ['10.234', '10']

# Falsiness in Ruby
#
# Write all the values that evaluate to "falsy" in Ruby. Write these values in
# a Ruby array.
# A non-boolean value that counts as true is called "truthy," and a non-boolean
# value that counts as false is called "falsey."

Diagnostic.falsy = ['string1'=='string', 1 == 2, array1[]==array2[]]
...
Diagnostic.array_add_to = '[2, 34,99]'
...
Diagnostic.person_hash = 'person{ :favorite_number "favorite_number, :first_name "first_name"}'

...
Diagnostic.returns = The answer is no it does not require an explicit return,
you can do it if you would like but not neccessary in Ruby. True or False is
not the right words to answer this question in my opinion.
...
Diagnostic.remove_from_array = 'delete_list = [2,3]

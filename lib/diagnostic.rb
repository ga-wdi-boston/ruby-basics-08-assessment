...
Diagnostic.variable = 'SW8 = "star wars episode viii"'
...
Diagnostic.integer = 'numbers are used as integer objects in Ruby'
...
Diagnostic.person_hash = 'person = Hash.new
person[:favorite_number] = [7]
person[:first_name] = ["rowland"]'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = "#rowland.${first_name} is trying to learn Ruby"'

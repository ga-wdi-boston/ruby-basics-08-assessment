...
check_if_odd = { |x| x.odd? ? }

Diagnostic.predicate = check_if_odd
...
Diagnostic.array_add_to = 'arr = [12, 34, , 99]'
...
Diagnostic.person_hash = 'person = {age: 26, first_name: "Vince"}'

# Set a default return value to your `person` hash that concatenates the value
# of person[:first_name] and a message about them.
# Write your response as a Ruby string.

Diagnostic.hash_default = 'person.default = person[:first_name].concat("is 26 years old")'
